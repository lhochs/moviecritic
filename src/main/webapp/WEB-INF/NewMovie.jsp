...
<body>
	<div id="add-movie">
		...
		<div class="add-movie-container">
			<div class="add-movie-center">
				<a class="add-movie navbar-brand" href="/" style="color: white; font-size: 30pt;"><img class="add-movie-nav-logo" src="/imgs/film.png" height="70">FlickList</a>
			</div>
			<div class="add-movie-nav"> 
